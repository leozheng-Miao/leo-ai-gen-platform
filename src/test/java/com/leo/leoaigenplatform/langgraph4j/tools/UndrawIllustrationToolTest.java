package com.leo.leoaigenplatform.langgraph4j.tools;

import com.leo.leoaigenplatform.langgraph4j.model.ImageCategoryEnum;
import com.leo.leoaigenplatform.langgraph4j.model.ImageResource;
...
class UndrawIllustrationToolTest {
    ...
    void testSearchIllustrations() {
        // 测试正常搜索插画
        List<ImageResource> illustrations = undrawIllustrationTool.searchIllustrations("sex");
