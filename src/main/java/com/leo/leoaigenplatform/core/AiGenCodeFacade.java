...
import com.leo.leoaigenplatform.ai.factory.AiGenCodeServiceFactory;
...
public class AiGenCodeFacade {
    ...
    public File generateAndSaveCode(String userMessage, CodeGenType codeType, Long appId) {
        ...
        AiGenCodeService service = aiGenCodeServiceFactory.getAiGenCodeService(appId);
    ...
    public Flux<String> generateAndSaveCodeStream(String userMessage, CodeGenType codeType, Long appId) {
        ...
        AiGenCodeService aiGenCodeService = aiGenCodeServiceFactory.getAiGenCodeService(appId, codeType);
