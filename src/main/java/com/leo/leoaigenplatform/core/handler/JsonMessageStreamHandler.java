package com.leo.leoaigenplatform.core.handler;

import cn.hutool.core.util.StrUtil;
import cn.hutool.json.JSONObject;
import cn.hutool.json.JSONUtil;
import com.leo.leoaigenplatform.ai.model.message.AiResponseMessage;
import com.leo.leoaigenplatform.ai.model.message.StreamMessage;
import com.leo.leoaigenplatform.ai.model.message.StreamMessageTypeEnum;
...
import com.leo.leoaigenplatform.ai.tools.BaseTool;
...
public class JsonMessageStreamHandler {
    ...
    public Flux<String> handle(Flux<String> originFlux,
                               ...
                               long appId, LoginUser loginUser) {
        // 收集数据用于生成后端记忆格式
        ...
        return originFlux
                ...
                .doOnComplete(() -> {
                    ...
                    log.info("流式响应完成，保存对话历史，长度：{}", aiResponse.length());
                    chatHistoryService.addChatMessage(appId, aiResponse, MessageType.AI.getValue(), loginUser.getId(), null);
                    String sourceDir = AppConstant.FILE_SAVE_ROOT_DIR + "/vue_project_" + appId;
                    vueProjectBuilder.buildProjectAsync(sourceDir);
                })
                .doOnError(error -> {
                    // 如果AI回复失败，也要记录错误消息
    ...
    private String handleJsonMessageChunk(String chunk, StringBuilder chatHistoryStringBuilder, Set<String> seenToolIds) {
        ...
        switch (typeEnum) {
            ...
            case TOOL_EXECUTED -> {
                ...
                BaseTool tool = toolManager.getTool(toolName);
                String result = tool.getToolExecutionResult(jsonObject);
                // 输出前端和要持久化的内容
